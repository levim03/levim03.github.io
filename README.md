...
## This repo holds the html code to display the published Power BI report regarding the weather and energy analysis project, the following text below is just the full description of the project
